        ...
        >
          ...
          <div className="space-y-4">
            ...
            <details className="group">
              ...
              >
                Navigate to Settings Edit Profile. Here you can update your
                personal information, photo, and preferences.
              </p>
            </details>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-4">
            <button
              ...
              className={`flex items-center w-full text-left hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded ${
                isDarkMode ? "text-white" : "text-gray-900"
              }`}
            >
